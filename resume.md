...
**Director of Embedded Engineering** | Vehicle HPC & Software-Defined Vehicle Architecture | Infotainment Systems | ISO 26262 & ISO 21434

**Current Role:** Director of Embedded and System Design Center, VinFast (May 2024 – Present)

---

## Executive Summary

Strategic embedded systems leader with 15+ years architecting vehicle compute platforms and intelligent cockpit systems. Proven expertise managing large cross-functional teams (50+ engineers) from System of Requirements definition through production deployment. Specializes in AUTOSAR architecture, functional safety compliance, and delivering mission-critical automotive solutions across platforms from mini-EVs to advanced driver assistance systems.
...
- System architecture, SOR/TR definition, ASPICE governance
- OEM and supplier engagement, pre-sales technical leadership
- Budget ownership and cross-functional team management

**Vehicle Architecture**
- Intelligent Cockpit: SomeIP/DoIP, head-unit architecture
- SoC/MCU selection: Qualcomm SA8155, NXP, Renesas integration
- Ethernet gateways, camera interfaces (FPD-Link, GMSL), audio DSP systems

**Safety & Security**
- ISO 26262 functional safety architecture
- ISO 21434 cybersecurity threat analysis (TARA)
- DFMEA and safety mechanism verification

**Embedded Platforms**
- AUTOSAR Classic and Adaptive
- FreeRTOS, embedded Linux, RTOS platforms
- CAN, LIN, Ethernet, BLE protocols; AWS IoT and OTA updates

---

## Key Achievements

**VinFast Head Unit (Intelligent Cockpit) | 2024 – Present**
- Architected complete system including processor split, OS selection, and domain interactions
- Secured €2M+ executive budget approval
- Led 25-person AUTOSAR and system team through DV/PV/System test gating
- Established supplier scorecards and acceptance criteria

**VinFast e-Mobility Platforms | 2020 – Present**
- Owned SOR/specifications for mini-EV infotainment and power ECUs (3-in-1 DCDC/OBC/PDU, VCU, EVCC)
- Implemented ISO 15118 Vehicle-to-Grid communication stack
- Governed ISO 26262 and ISO 21434 compliance across supplier chain

**Viettel SDR/HF Radio Platform | 2012 – 2018**
- Architected Software-Defined Radio for Navy and tactical communications
- Developed ALE-2G/3G protocol stacks with MELP vocoder and JPEG-2000 imaging

---

## Professional Experience

**Director of Embedded and System Design Center | VinFast (May 2024 – Present)**
- Direct 50+ engineers across firmware, system architecture, and application development
- Govern system requirements, ASPICE compliance, and Design Verification gating
- Manage supplier relationships and technical assessments

**Senior Director, Embedded Engineering | VinFast (2020 – May 2024)**
- Architected firmware strategies for EV powertrains and battery management systems
- Managed ISO 26262 and ISO 21434 compliance across 8+ vendors
- Coordinated OEM technical reviews and system integration

**Manager, Software Engineering | Viettel R&D Center (2012 – 2020)**
- Managed 15-person embedded systems team
- Led SDR and wireless protocol stack development for tactical communications

**Senior Embedded Engineer | Toshiba Semiconductor Vietnam (2008 – 2012)**
- Developed BSPs, bootloaders, and AUTOSAR device drivers
- Optimized low-power firmware for IoT and automotive applications
...
- **Email:** luunhuhoa@gmail.com
- **LinkedIn:** linkedin.com/in/hoaln
- **GitHub:** github.com/hoaln
